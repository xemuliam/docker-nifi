...
sed -i "s/server\.1=/server.1=$HOSTNAME:2888:3888/g" ${NIFI_HOME}/conf/nifi.properties

# State management xml
  mkdir ${NIFI_HOME}/state && mkdir ${NIFI_HOME}/state/zookeeper && echo ${MYID} > ${NIFI_HOME}/state/zookeeper/myid
}
